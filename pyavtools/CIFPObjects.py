...
NM_FEET= NAUT_MILES_PER_METER / FEET_METER 
...
"""
    ...
    def render(self, pov, display_object, display_width, aircraft_pos):
        ...
        p11_lng,p11_lat = AddPosition(centerpoint, width_2_nm, width_bearing)
        p11 = pov.point2D (p11_lat, p11_lng)
        p21_lng,p21_lat = AddPosition(otherpoint, width_2_nm, width_bearing)
        ...
        if width_bearing <= -360:
            width_bearing += 360
        p12_lng,p12_lat = AddPosition(centerpoint, width_2_nm, width_bearing)
        p12 = pov.point2D (p12_lat, p12_lng)
        p22_lng,p22_lat = AddPosition(otherpoint, width_2_nm, width_bearing)
